...
public class Methods {
    public static void display(){
        Vector<Integer> numbers = new Vector<>();      // or Vector numbers = new Vector();  
...
// o=object, e=element, c=collection, a=array, i=index
        ...
        // Vector ============================================================================================================>
                ...
                // copyInto(o)  ------------- void ====================> copy the vector and make a new Array.
                // trimToSize() ------------- void ====================> change the item storing capacity to vector's own size
                // removeElementAt(i) ------- void ====================> remove an element from the Vector by following index number.
                // insertElementAt(o, i) ---- void ====================> insert an element into Vector by following index number.
                // setSize(o) --------------- void ====================> set the new size of a Vector.
                // capacity()  -------------- int =====================> total element storing capacity of a Vector.
                // ensureCapacity(o)  ------- void ====================> increase or decrease the element storing capacity of a Vector.
                // elements() --------------- element data type =======> Creating an empty enumeration to store in it.
                // elementAt(i) ------------- indexed item data type ==> get the element from the Vector.
                // firstElement() ----------- element data type =======> get the first element from the Vector.
                // lastElement() ------------ element data type =======> get the last element from the Vector.
                // setElementAt(o, i) ------- void ====================> change an existing element of the Vector by following the index number.
                // removeElement(o) --------- boolean =================> remove an element from the Vector.
                // removeAllElements() ------ void ====================> remove all element from the Vector.
                // removeElementAt(i) ------- void ====================> remove an element from the Vector by following the index number.
                // addElement(o) ------------ void ====================> add new element at the last position of the Vector.
...
///////////////////////////////////////////////////////////////////////////////////////
/////////////////////// Vector<Type> numbers = new Vector<>(); ////////////////////////
...
// firstElement() ----------- element data type =======> get the first element from the Vector.
        ...
        Vector<String> myVect = new Vector<>(Arrays.asList("A", "B", "C"));
...
// lastElement() ------------ element data type =======> get the last element from the Vector.
        ...
        Vector<String> myVect3 = new Vector<>(Arrays.asList("A", "B", "C"));
...
// removeElement(o) --------- boolean =================> remove an element from the Vector.
        ...
        Vector<String> myVect4 = new Vector<>(Arrays.asList("A", "B", "C"));
...
// clone()  ---------------- List =====================> Creates a new list with the same element, size, and capacity.
        Vector mAL9 = (Vector) numbers.clone();
...
// addAll(i, c) ------------ boolean  =================> add all element to the list by following index number.
        Vector<Integer> newIntLis = new Vector<>(Arrays.asList(123, 456));
        numbers.addAll(0, newIntLis);

        System.out.println(numbers);


        Vector<Integer> newLs = new Vector<>(Arrays.asList(123, 456));
...
// indexOf(o) -------------- int  =====================> print the exact index of the object
        ...
        Vector<String> mll5 = new Vector<>(Arrays.asList("A", "C", "D", "A", "D", "C", "B"));
...
// lastIndexOf(o) ---------- int ======================> print the exact index number of last object(multiple object can be same).
        ...
        Vector<String> mll9 = new Vector<>(Arrays.asList("A", "C", "D", "A", "D", "C", "B"));
...
// subList(start i, end i) - list =====================> copy the list by following stating and ending index number.
        Vector<String> mAL8 = new Vector<>(Arrays.asList("A", "B", "C", "D", "E", "F"));

        System.out.println(numbers);

        Vector<String> myList3 = new Vector<>(mAL8.subList(1, 4));
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        Vector anotherList = new Vector<>(Arrays.asList("tuhin", 230, 45.234f, true, 'M', 656.343d));
...
// removeAll(c) ----------- boolean  =================> remove all elements from list, that is similar.
        ...
        Vector<Integer> newIntList1 = new Vector<>(Arrays.asList(22, 33, 44, 55, 66));
...
// parallelStream() ------- Stream ===================> Returns a possibly parallel Stream with this collection as its source.
        Vector<String> strings = new Vector<>(Arrays.asList("abc", "", "bc", "efg", "abcd","", "jkl"));
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        Vector<Integer> number = new Vector<>(Arrays.asList(2,3,4,5,6,7));
...
// replaceAll(list, find, replace) ---- void ==========> replace all the item of the list.
        Vector<String> al1 = new Vector<>(Arrays.asList("A", "B", "A", "D"));
        Collections.replaceAll(al1, "A", "Tuhin");
        System.out.println(al1);

        Vector<Integer> al2 = new Vector<>(Arrays.asList(11, 22, 33, 11, 44));
...
// copy() ----------- void ============> creates a copy of elements from the specified source to destination
        Vector<Integer> asdf = new Vector<>();

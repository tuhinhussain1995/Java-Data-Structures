...
public class Methods {
    public static void display(){
        ArrayList<Integer> numbers = new ArrayList<>();      // or ArrayList numbers = new ArrayList();
...
// o=object, e=element, c=collection, a=array, i=index
        ...
        // java.util.ArrayList ========================================================================================>
                ...
                // trimToSize()  ----------- void ======================> Reduces the capacity of an array list to its current size.
                // ensureCapacity(o) ------- void ======================> increases the capacity of this ArrayList. Total elements that a arraylist can contain.
...
//////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////// ArrayList<Type> numbers = new ArrayList<>(); ////////////////////////
...
// trimToSize()  ----------- void ======================> Reduces the capacity of an array list to its current size.
        // trimToSize() not effective for ArrayList.

        ArrayList<Integer> arr = new ArrayList<>();

        arr.ensureCapacity(111);
...
// clone()  ---------------- List =====================> Creates a new list with the same element, size, and capacity.
        ArrayList<String> mAL1 = new ArrayList<>(Arrays.asList("A", "B", "C", "D", "E"));
        ArrayList mAL2 = (ArrayList) mAL1.clone();
...
// remove(i) --------------- removed item data type ===> remove element from list by following index number.
        ...
        ArrayList<String> myAL = new ArrayList<>(Arrays.asList("A", "B", "C", "D", "E"));
        myAL.remove("B");
        myAL.remove(2);
...
// indexOf(o) -------------- int  =====================> print the exact index of the object
        ...
        ArrayList<String> mll5 = new ArrayList<>(Arrays.asList("A", "C", "D", "A", "D", "C", "B"));
...
// lastIndexOf(o) ---------- int ======================> print the exact index number of last object(multiple object can be same).
        ...
        ArrayList<String> mll9 = new ArrayList<>(Arrays.asList("A", "C", "D", "A", "D", "C", "B"));
...
// subList(start i, end i) - list =====================> copy the list by following stating and ending index number.
        ...
        ArrayList<String> myList3 = new ArrayList<>(mAL8.subList(1, 4));
        System.out.println(myList3);

// clone()  ---------------- List =====================> Creates a new list with the same element, size, and capacity.
        Vector mAL9 = (Vector) mAL8.clone();
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        ArrayList anotherList = new ArrayList<>(Arrays.asList("tuhin", 230, 45.234f, true, 'M', 656.343d));
...
// containsAll(c)---------- boolean ==================> check if the item collections is exist inside the list or not.
        ArrayList<Integer> myIntList1 = new ArrayList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// retainAll(c)------------ boolean  =================> remove all elements that is not similar.
        ArrayList<Integer> myList4 = new ArrayList<>(Arrays.asList(22, 33, 44, 55, 66));
        ...
        ArrayList<Integer> myList1 = new ArrayList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// equals(o)--------------- boolean ==================> check if two list is equal or not.
        ArrayList<Integer> myIntList4 = new ArrayList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// parallelStream() ------- Stream ===================> Returns a possibly parallel Stream with this collection as its source.
        ArrayList<String> strings = new ArrayList<>(Arrays.asList("abc", "", "bc", "efg", "abcd","", "jkl"));
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        ArrayList<Integer> number = new ArrayList<>(Arrays.asList(2,3,4,5,6,7));
...
// replaceAll(list, find, replace) ---- void ==========> replace all the item of the list.
        ArrayList<String> al1 = new ArrayList<>(Arrays.asList("A", "B", "A", "D"));
        Collections.replaceAll(al1, "A", "Tuhin");
        System.out.println(al1);

        ArrayList<Integer> al2 = new ArrayList<>(Arrays.asList(11, 22, 33, 11, 44));

...
public class Methods {
    public static void display() {
        LinkedHashSet<Integer> numbers = new LinkedHashSet<>();      // or LinkedHashSe<Integer> numbers = new LinkedHashSet();
...
// o=object, e=element, c=collection, a=array, i=index
    ...
    // LinkedHashSet extends HashSet:
        ...
        // HashSet =================================================================================================>
                        // =====> (LinkedHashSet<Integer> numbers = new LinkedHashSet<>();)   or   (LinkedHashSet numbers = new LinkedHashSet();)
...
// clone()  ---------------- Set =====================> Creates a new set with the same element, size, and capacity.
        LinkedHashSet<String> mAL1 = new LinkedHashSet<>(Arrays.asList("A", "B", "C", "D", "E"));
...
// isEmpty()--------------- boolean ==================> check is the list is empty or not.
        ...
        LinkedHashSet<String> myStringList = new LinkedHashSet<>();
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        LinkedHashSet anotherList = new LinkedHashSet<>(Arrays.asList("tuhin", 230, 45.234f, true, 'M', 656.343d));
...
// containsAll(c)---------- boolean ==================> check if the item collections is exist inside the list or not.
        LinkedHashSet<Integer> myIntList1 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
        LinkedHashSet<Integer> myIntList2 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
...
// addAll(c)--------------- boolean  =================> add all element to the list
        ...
        // Sixth: (from Vector)
        LinkedHashSet<Integer> vi = new LinkedHashSet<>(Arrays.asList(23, 232, 23));
...
// retainAll(c)------------ boolean  =================> remove all elements that is not similar.
        LinkedHashSet<Integer> myList4 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
        ...
        LinkedHashSet<Integer> myList1 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
...
// equals(o)--------------- boolean ==================> check if two list is equal or not.
        LinkedHashSet<Integer> myIntList4 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
        LinkedHashSet<Integer> myIntList5 = new LinkedHashSet<>(Arrays.asList(22, 33, 44, 55, 66));
...
// removeIf(filter) ------- boolean  =================> remove the element by using filter
        LinkedHashSet<String> myAL = new LinkedHashSet<>(Arrays.asList("A", "B", "C", "D", "E"));
...
// parallelStream() ------- Stream ===================> Returns a possibly parallel Stream with this collection as its source.
        LinkedHashSet<String> strings = new LinkedHashSet<>(Arrays.asList("abc", "", "bc", "efg", "abcd","", "jkl"));
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        LinkedHashSet<Integer> number = new LinkedHashSet<>(Arrays.asList(2,3,4,5,6,7));

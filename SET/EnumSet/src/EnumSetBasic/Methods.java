...
// o=object, e=element, c=collection, a=array, i=index
        ...
        // EnumSet =========================================================>
                        // =====> (EnumSet<Enum> sizes1 = EnumSet.allOf(Size.class);) or (EnumSet sizes1 = EnumSet.allOf(Size.class);)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// java.util.EnumSet ///////////////////////////////////////////////////
//////// (EnumSet<Type> sizes1 = EnumSet.allOf(Size.class);)  or (EnumSet sizes1 = EnumSet.allOf(Size.class);)
///////////////////////////////////////////////////////////////////////////////////////////////////


// clone():  ----- Creates a new set with the same element, size, and capacity.
        EnumSet<Size> mAL1 = EnumSet.allOf(Size.class);
        EnumSet mAL2 = (EnumSet) mAL1.clone();

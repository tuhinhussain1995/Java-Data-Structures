...
public class Methods {
    public static void display() {
        Queue<Integer> numbers = new LinkedList<>();      // or new LinkedList/ArrayDeque/PriorityQueue<>();

// o=object, e=element, c=collection, a=array, i=index

        // Queue  ===========================================================>
                        // ======> Queue<Type> numbers = new LinkedList<>();         // or new LinkedList/ArrayDeque/PriorityQueue<>();
                        // ======> Queue myQueue = new LinkedList();                // or new LinkedList/ArrayDeque/PriorityQueue<>();
                        // ======> Queue<Object> list=new LinkedList<Object>();     // or new LinkedList/ArrayDeque/PriorityQueue<>();
...
// isEmpty()--------------- boolean ==================> check is the list is empty or not.
        ...
        Queue<String> myStringList = new LinkedList<>();
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        Queue anotherList = new LinkedList(Arrays.asList("tuhin", 230, 45.234f, true, 'M', 656.343d));
...
// containsAll(c)---------- boolean ==================> check if the item collections is exist inside the list or not.
        Queue<Integer> myIntList1 = new LinkedList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// removeAll(c) ----------- boolean  =================> remove all elements from list, that is similar.
        ...
        Queue<Integer> newIntList1 = new LinkedList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// retainAll(c)------------ boolean  =================> remove all elements that is not similar.
        Queue<Integer> myList4 = new LinkedList<>(Arrays.asList(22, 33, 44, 55, 66));
        ...
        Queue<Integer> myList1 = new LinkedList<>(Arrays.asList(22, 33, 44, 55, 66));

        Integer[] myArray = new Integer[] {11, 22, 33, 77, 99};
        Queue<Integer> myList2 = new LinkedList<>(Arrays.asList(myArray));
...
// equals(o)--------------- boolean ==================> check if two list is equal or not.
        Queue<Integer> myIntList4 = new LinkedList<>(Arrays.asList(22, 33, 44, 55, 66));
...
// parallelStream() ------- Stream ===================> Returns a possibly parallel Stream with this collection as its source.
        Queue<String> strings = new LinkedList<>(Arrays.asList("abc", "", "bc", "efg", "abcd","", "jkl"));
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        Queue<Integer> number = new LinkedList<>(Arrays.asList(2,3,4,5,6,7));

...
public class Methods {
    public static void display() throws InterruptedException {
        LinkedBlockingDeque<Integer> numbers = new LinkedBlockingDeque<>();
...
// o=object, e=element, c=collection, a=array, i=index
        ...
        // LinkedBlockingDeque  ==========================================================================================================================================>
                        ...
                        // ======> LinkedBlockingDeque<Object> list=new LinkedBlockingDeque<Object>();
...
// drainTo(c) --------------- int =====================>  removes all available elements from this LinkedBlocking Queue and adds them to the given collection passed as a parameter.
        LinkedBlockingDeque<Integer> numb = new LinkedBlockingDeque<>();
...
// remove() ----------------- removed item data type ==> remove first element of the deque.
        ...
        LinkedBlockingDeque<String> myAL = new LinkedBlockingDeque<>();
...
// isEmpty()--------------- boolean ==================> check is the list is empty or not.
        ...
        LinkedBlockingDeque<String> myStringList = new LinkedBlockingDeque<>();
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        LinkedBlockingDeque anotherList = new LinkedBlockingDeque(45);
...
// containsAll(c)---------- boolean ==================> check if the item collections is exist inside the list or not.
        LinkedBlockingDeque<Integer> myIntList1 = new LinkedBlockingDeque<>(44);
...
// removeAll(c) ----------- boolean  =================> remove all elements from list, that is similar.
        ...
        LinkedBlockingDeque<Integer> newIntList1 = new LinkedBlockingDeque<>();
...
// retainAll(c)------------ boolean  =================> remove all elements that is not similar.
        LinkedBlockingDeque<Integer> myList4 = new LinkedBlockingDeque<>();
        ...
        LinkedBlockingDeque<Integer> myList1 = new LinkedBlockingDeque<>();
        myList1.addAll(Arrays.asList(22, 33, 44, 55, 66));

        Integer[] myArray = new Integer[] {11, 22, 33, 77, 99};
        LinkedBlockingDeque<Integer> myList2 = new LinkedBlockingDeque<>();
...
// equals(o)--------------- boolean ==================> check if two list is equal or not.
        LinkedBlockingDeque<Integer> myIntList4 = new LinkedBlockingDeque<>();
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        LinkedBlockingDeque<Integer> number = new LinkedBlockingDeque<>();

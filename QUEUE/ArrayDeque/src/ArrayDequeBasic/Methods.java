...
// o=object, e=element, c=collection, a=array, i=index
        ...
        // ArrayDeque  =================================================================================================>
                        // ======> ArrayDeque<Type> numbers = new ArrayDeque<>();
                        // ======> ArrayDeque myQueue = new ArrayDeque();
...
// clone()  ---------------- List =====================> Creates a new list with the same element, size, and capacity.
        ArrayDeque mAL9 = (ArrayDeque) numbers.clone();
...
// isEmpty()--------------- boolean ==================> check is the list is empty or not.
        ...
        ArrayDeque<String> myStringList = new ArrayDeque<>();
...
// remove(o)--------------- boolean  =================> remove element from list by following object.
        ArrayDeque anotherList = new ArrayDeque(Arrays.asList("tuhin", 230, 45.234f, true, 'M', 656.343d));
...
// containsAll(c)---------- boolean ==================> check if the item collections is exist inside the list or not.
        ArrayDeque<Integer> myIntList1 = new ArrayDeque<>(Arrays.asList(22, 33, 44, 55, 66));
...
// removeAll(c) ----------- boolean  =================> remove all elements from list, that is similar.
        ...
        ArrayDeque<Integer> newIntList1 = new ArrayDeque<>(Arrays.asList(22, 33, 44, 55, 66));
...
// retainAll(c)------------ boolean  =================> remove all elements that is not similar.
        ArrayDeque<Integer> myList4 = new ArrayDeque<>(Arrays.asList(22, 33, 44, 55, 66));
        ...
        ArrayDeque<Integer> myList1 = new ArrayDeque<>(Arrays.asList(22, 33, 44, 55, 66));

        Integer[] myArray = new Integer[] {11, 22, 33, 77, 99};
        ArrayDeque<Integer> myList2 = new ArrayDeque<>(Arrays.asList(myArray));
...
// equals(o)--------------- boolean ==================> check if two list is equal or not.
        ArrayDeque<Integer> myIntList4 = new ArrayDeque<>(Arrays.asList(22, 33, 44, 55, 66));
...
// parallelStream() ------- Stream ===================> Returns a possibly parallel Stream with this collection as its source.
        ArrayDeque<String> strings = new ArrayDeque<>(Arrays.asList("abc", "", "bc", "efg", "abcd","", "jkl"));
...
// forEach(action) --------- void =====================> use for(java.util.Objects myVar : myList){}
        ...
        // Second Way:
        ArrayDeque<Integer> number = new ArrayDeque<>(Arrays.asList(2,3,4,5,6,7));
